...
public class Nova_I18nWrap
{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetLocalizedStrings(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			string arg0 = ToLua.CheckString(L, 1);
			object[] arg1 = ToLua.ToParamsObject(L, 2, count - 1);
			System.Collections.Generic.Dictionary<UnityEngine.SystemLanguage,string> o = Nova.I18n.GetLocalizedStrings(arg0, arg1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_LocalizedResourcesPath(IntPtr L)
	{
		try
		{
			LuaDLL.lua_pushstring(L, Nova.I18n.LocalizedResourcesPath);
			return 1;
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_LocalizedStringsPath(IntPtr L)
	{
		try
		{
