...
public static partial class LuaBinder
{
	static partial void Bind_Gen(LuaState L)
	{
		...
		Nova_OpacityAnimationPropertyWrap.Register(L);
		Nova_PitchAnimationPropertyWrap.Register(L);
		...
		Nova_TextFadeInAnimationPropertyWrap.Register(L);
		Nova_TimeAnimationPropertyWrap.Register(L);
		Nova_VerticalScrollRectAnimationPropertyWrap.Register(L);
		...
		Nova_ChoiceImageInformationWrap.Register(L);
		...
		Nova_GameViewControllerWrap.Register(L);
		Nova_AnimationPropertyWrap.Register(L);
		...
		Nova_PanelControllerWrap.Register(L);
		Nova_ViewControllerBaseWrap.Register(L);
		L.BeginModule("DialogueState");
		Nova_DialogueState_StateWrap.Register(L);
		L.EndModule();
		L.BeginModule("ChoiceOccursData");
		Nova_ChoiceOccursData_ChoiceWrap.Register(L);
		L.EndModule();
